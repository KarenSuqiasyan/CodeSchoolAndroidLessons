...
import com.common.codeschoolandroidlessons.databinding.MyDialogLayoutBinding
...
class MyDialog(context: Context, message: String, ticTacToeView: TicTacToeView) :
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.exitButton.setOnClickListener {
            val intent =
                Intent(context, com.cshomework.codeschoolandroidlessons.MainActivity::class.java)
