package com.cshomework.codeschoolandroidlessons.multiple_recyclerview.ui.adapter
...
import com.common.codeschoolandroidlessons.databinding.ItemImageBinding
import com.common.codeschoolandroidlessons.databinding.ItemTextBinding
import com.common.codeschoolandroidlessons.databinding.ItemUrlBinding
import com.common.codeschoolandroidlessons.databinding.ItemVideoBinding
...
class PostAdapter(private val postItemClickListener: (PostActionEnum, Any) -> Unit) : RecyclerView.Adapter<PostAdapter.BaseViewHolder>() {
    ...
    abstract inner class BaseViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private fun shareButton() = itemView.findViewById(R.id.shareButton) as AppCompatButton
